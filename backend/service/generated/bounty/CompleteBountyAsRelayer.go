...
type CompleteBountyAsRelayer struct {
...
// NewCompleteBountyAsRelayerInstructionBuilder creates a new `CompleteBountyAsRelayer` instruction builder.
func NewCompleteBountyAsRelayerInstructionBuilder() *CompleteBountyAsRelayer {
	nd := &CompleteBountyAsRelayer{
...
// only owners or relayers can complete bounties
func (inst *CompleteBountyAsRelayer) SetPayerAccount(payer ag_solanago.PublicKey) *CompleteBountyAsRelayer {
...
// only owners or relayers can complete bounties
func (inst *CompleteBountyAsRelayer) GetPayerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetProtocolAccount sets the "protocol" account.
func (inst *CompleteBountyAsRelayer) SetProtocolAccount(protocol ag_solanago.PublicKey) *CompleteBountyAsRelayer {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(protocol)
	return inst
}

// GetProtocolAccount gets the "protocol" account.
func (inst *CompleteBountyAsRelayer) GetProtocolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetFeeCollectorAccount sets the "feeCollector" account.
func (inst *CompleteBountyAsRelayer) SetFeeCollectorAccount(feeCollector ag_solanago.PublicKey) *CompleteBountyAsRelayer {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(feeCollector).WRITE()
	return inst
}

// GetFeeCollectorAccount gets the "feeCollector" account.
func (inst *CompleteBountyAsRelayer) GetFeeCollectorAccount() *ag_solanago.AccountMeta {
...
// bounty denomination is the allowed denomination of a bounty
// it needs to be checked against the fee collector and the mint
func (inst *CompleteBountyAsRelayer) SetBountyDenominationAccount(bountyDenomination ag_solanago.PublicKey) *CompleteBountyAsRelayer {
...
// bounty denomination is the allowed denomination of a bounty
// it needs to be checked against the fee collector and the mint
func (inst *CompleteBountyAsRelayer) GetBountyDenominationAccount() *ag_solanago.AccountMeta {
...
// bounty to be completed
// FIXME
func (inst *CompleteBountyAsRelayer) SetBountyAccount(bounty ag_solanago.PublicKey) *CompleteBountyAsRelayer {
...
// bounty to be completed
// FIXME
func (inst *CompleteBountyAsRelayer) GetBountyAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetEscrowAccount sets the "escrow" account.
func (inst *CompleteBountyAsRelayer) SetEscrowAccount(escrow ag_solanago.PublicKey) *CompleteBountyAsRelayer {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(escrow).WRITE()
	return inst
}

// GetEscrowAccount gets the "escrow" account.
func (inst *CompleteBountyAsRelayer) GetEscrowAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetSolver1Account sets the "solver1" account.
// up to 4 receivers
func (inst *CompleteBountyAsRelayer) SetSolver1Account(solver1 ag_solanago.PublicKey) *CompleteBountyAsRelayer {
...
// up to 4 receivers
func (inst *CompleteBountyAsRelayer) GetSolver1Account() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetSolver2Account sets the "solver2" account.
func (inst *CompleteBountyAsRelayer) SetSolver2Account(solver2 ag_solanago.PublicKey) *CompleteBountyAsRelayer {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(solver2).WRITE()
	return inst
}

// GetSolver2Account gets the "solver2" account.
func (inst *CompleteBountyAsRelayer) GetSolver2Account() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetSolver3Account sets the "solver3" account.
func (inst *CompleteBountyAsRelayer) SetSolver3Account(solver3 ag_solanago.PublicKey) *CompleteBountyAsRelayer {
	inst.AccountMetaSlice[8] = ag_solanago.Meta(solver3).WRITE()
	return inst
}

// GetSolver3Account gets the "solver3" account.
func (inst *CompleteBountyAsRelayer) GetSolver3Account() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetSolver4Account sets the "solver4" account.
func (inst *CompleteBountyAsRelayer) SetSolver4Account(solver4 ag_solanago.PublicKey) *CompleteBountyAsRelayer {
	inst.AccountMetaSlice[9] = ag_solanago.Meta(solver4).WRITE()
	return inst
}

// GetSolver4Account gets the "solver4" account.
func (inst *CompleteBountyAsRelayer) GetSolver4Account() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetSystemProgramAccount sets the "systemProgram" account.
func (inst *CompleteBountyAsRelayer) SetSystemProgramAccount(systemProgram ag_solanago.PublicKey) *CompleteBountyAsRelayer {
	inst.AccountMetaSlice[10] = ag_solanago.Meta(systemProgram)
	return inst
}

// GetSystemProgramAccount gets the "systemProgram" account.
func (inst *CompleteBountyAsRelayer) GetSystemProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetTokenProgramAccount sets the "tokenProgram" account.
func (inst *CompleteBountyAsRelayer) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *CompleteBountyAsRelayer {
	inst.AccountMetaSlice[11] = ag_solanago.Meta(tokenProgram)
	return inst
}

// GetTokenProgramAccount gets the "tokenProgram" account.
func (inst *CompleteBountyAsRelayer) GetTokenProgramAccount() *ag_solanago.AccountMeta {
...
// relayer that wants to complete the transaction
// validate the seeds
func (inst *CompleteBountyAsRelayer) SetRelayerAccount(relayer ag_solanago.PublicKey) *CompleteBountyAsRelayer {
	inst.AccountMetaSlice[12] = ag_solanago.Meta(relayer)
	return inst
}
...
// relayer that wants to complete the transaction
// validate the seeds
func (inst *CompleteBountyAsRelayer) GetRelayerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(12)
}

func (inst CompleteBountyAsRelayer) Build() *Instruction {
	return &Instruction{BaseVariant: ag_binary.BaseVariant{
		Impl:   inst,
		TypeID: Instruction_CompleteBountyAsRelayer,
	}}
}
...
func (inst CompleteBountyAsRelayer) ValidateAndBuild() (*Instruction, error) {
...
func (inst *CompleteBountyAsRelayer) Validate() error {
...
func (inst *CompleteBountyAsRelayer) EncodeToTree(parent ag_treeout.Branches) {
	parent.Child(ag_format.Program(ProgramName, ProgramID)).
		//
		ParentFunc(func(programBranch ag_treeout.Branches) {
			programBranch.Child(ag_format.Instruction("CompleteBountyAsRelayer")).
				//
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=13]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("           relayer", inst.AccountMetaSlice.Get(12)))
					})
				})
		})
}

func (obj CompleteBountyAsRelayer) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	return nil
}
func (obj *CompleteBountyAsRelayer) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	return nil
}

// NewCompleteBountyAsRelayerInstruction declares a new CompleteBountyAsRelayer instruction with the provided parameters and accounts.
func NewCompleteBountyAsRelayerInstruction(
	// Accounts:
	...
	relayer ag_solanago.PublicKey) *CompleteBountyAsRelayer {
	return NewCompleteBountyAsRelayerInstructionBuilder().
